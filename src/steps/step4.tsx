      ...
      <div className="flex flex-col mb-10">
        ...
        <form className="w-full max-w p-10 form-select" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="mb-10">
            ...
            <InputText placeholder="Digite Aqui" {...register('TargetHipPelvisExtremities')} />
          </div>
              ...
              <Disclosure.Panel>
                ...
                <>
                  {procedures.map((procedure: ProcedureProps) => (
                    <div>
                      <input type="checkbox" id={procedure.title} value={procedure.title} key={procedure.title} {...register("proceduresHipsPelvisExtremities")} />
