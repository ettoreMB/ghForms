        ...
        <form className="" onSubmit={handleSubmit(onSubmit)}>
          <div className="mb-4">
            ...
            <div className="flex flex-col pl-4">
              <div>
                <input className="form-checkbox" defaultChecked={state?.data.questao_2_1} type="checkbox" {...register("questao_2_1")} />
                <label className="ml-4">
                  Somos líderes em procedimentos cirúrgicos de trauma e conduzimos mais do que a média hospitalar em nosso país.
                </label>
              </div>
              <div>
                <input className="form-checkbox" type="checkbox" defaultChecked={state.data.questao_2_2} {...register("questao_2_2")} />
                <label className="ml-4">
                  Estamos em  igualdade com a média nacional de procedimentos cirúrgicos de trauma que estão sendo realizados.
                </label>
              </div>
              <div>
                <input className="form-checkbox" type="checkbox" defaultChecked={state.data.questao_2_3} {...register("questao_2_3")} />
                <label className="ml-4">
          ...
          <div className="mb-4">
            ...
            <textarea placeholder="Resposta" defaultValue={state.data.questao_3} {...register('questao_3')}></textarea>
          </div>
          ...
          <div className="mb-4" >
            ...
            <textarea placeholder="Resposta" defaultValue={state.data.questao_4} {...register('questao_4')}></textarea>
          </div>
