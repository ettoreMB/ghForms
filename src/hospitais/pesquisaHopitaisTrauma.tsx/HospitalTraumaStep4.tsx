        ...
        <form className="" onSubmit={handleSubmit(onSubmit)}>
          <div className="mb-4">
            ...
            <div className="flex flex-col pl-4">
              <div>
                <input className="form-checkbox" defaultChecked={values?.data.questao_2_1} type="checkbox" {...register("questao_2_1")} />
          ...
          <div className="mb-4">
            ...
            <textarea placeholder="Resposta" defaultValue={values?.data.questao_3} {...register('questao_3')}></textarea>
          </div>
          ...
          <div className="mb-4" >
            ...
            <textarea placeholder="Resposta" defaultValue={values?.data.questao_4} {...register('questao_4')}></textarea>
          </div>
