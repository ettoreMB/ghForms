          ...
          <div >
            ...
            <div className="pl-4">
              ...
              <div className="mb-2">
                ...
                <InputText type='text' label="Placas e Parafusos" defaultValue={values.data.questao_8_3_1} {...register("questao_8_3_1")} />
                <InputText type='text' label="Pinos" defaultValue={values.data.questao_8_3_2} {...register("questao_8_3_2")} />
                <InputText type='text' label="Parafusos cânulados" defaultValue={values.data.questao_8_3_3} {...register("questao_8_3_3")} />
                <InputText type='text' label="Fixações Externas" defaultValue={values.data.questao_8_3_4} {...register("questao_8_3_4")} />
              </div>
            </div>
            <div>
              <h3>9.	Que termos você normalmente negocia com os hospitais para os produtos acima mencionados? </h3>
              <textarea defaultValue={values.data.questao_9} {...register("questao_9")} />
            </div>
            <div>
              <h3>10. Qual é o processo de compra para a introdução desses produtos as companhias de seguro médico? </h3>
              <textarea defaultValue={values.data.questao_10} {...register("questao_10")} />
            </div>
            <div>
              <h3>• Existe algum processo de avaliação para identificar e testar novos produtos? </h3>
              <textarea defaultValue={values.data.questao_10_1} {...register("questao_10_1")} />
            </div>
            <div>
              <h3>• Existe uma expectativa de que o fabricante forneça treinamento antes de introduzir um novo produto? </h3>
              <textarea defaultValue={values.data.questao_10_2} {...register("questao_10_2")} />
            </div>
          </div>
          <div>
            <h3>• Que termos você normalmente negocia com os seguros de saúde para os produtos acima mencionados?</h3>
            <textarea defaultValue={values.data.questao_10_3} {...register("questao_10_3")} />
          </div>
