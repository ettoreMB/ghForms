          ...
          <div >
            ...
            <div className="pl-4">
              ...
              <div className="mb-2">
                ...
                <InputText type='text' label="Placas e Parafusos"  {...register("questao_8_3_1")} />
                <InputText type='text' label="Pinos" {...register("questao_8_3_2")} />
                <InputText type='text' label="Parafusos cânulados"  {...register("questao_8_3_3")} />
                <InputText type='text' label="Fixações Externas"  {...register("questao_8_3_4")} />
              </div>
            </div>
            <div>
